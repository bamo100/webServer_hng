...
const ipinfoApiKey = '4aab3fb8a0704b13a31b86f08a0f7802';
...
app.get('/api/hello', async (req, res) => {
    ...
    try {
        ...
        const geoUrl = `https://api.ipgeolocation.io/ipgeo?apiKey=${ipinfoApiKey}&ip=${clientIp}`
        console.log(`Geo URL: ${geoUrl}`);

        const geoResponse = await axios.get(geoUrl);
        console.log('Geo Response:', geoResponse.data);

        // if (!geoResponse.data.latitude) {
